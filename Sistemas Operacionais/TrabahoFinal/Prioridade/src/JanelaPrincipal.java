...
public class JanelaPrincipal extends javax.swing.JFrame {
    ...
    PriorityQueue<String> listaNomes = new PriorityQueue<String>();
    PriorityQueue<Integer> listaTempo = new PriorityQueue<Integer>();
    PriorityQueue<Integer> listaPosicao = new PriorityQueue<Integer>();
    ...
    private void btnInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirActionPerformed
        ...
        System.out.println("|Nome\t|Tempo\t|Posicao");
        for (i = 0; i < registros; i++) {
            System.out.println("|" + listaNomes.get(i) + "\t|" + listaTempo.get(i) + "\t|" + listaPosicao.get(i));
        }
        System.out.println("---------------------------------");
